  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
              ...
              <a>
                <div class="widget-user-header box-shadow-sm" style="padding: 10px 10px 5px 10px;">
                  ...
                  <h5 class="widget-user-desc box-title text-black">
                    <?php if(!empty($lectura) && !empty($lec_alumno)){echo $lec_alumno->intentos_vf."/".$lectura->attemps;} ?>
                  </h5>
        ...
        <div id="test_result_vf">
          <?php if(!empty($reactivos) && $lec_alumno->intentos_vf < $lectura->attemps && $lec_alumno->fin_vf == 0){ ?>
          <div class="box box-solid box-shadow-sm">
            ...
            <div class="box-body">
              <?php $index = 1; ?>
              <form id="from_test_vf" method="post" action="<?php echo base_url().'Movil/Actividades/verificar_vf'?>/<?php if(!empty($lectura)){echo $lectura->idLectura;} ?>" class="padding-square-no-top-bottom">
                ...
                <blockquote class=" bg-block-gray">
                  <h4 class="reactivo">
                    ...
                    <!-- identificador -->
                    <?php echo "<input class='question_hide' value='".$reactivo->idVerdaderoFalso."' name='idrom".$index."' hidden='hidden'>"; ?>
                  </h4>
                  <!-- respuestas -->
                    <div id="sdd" class=" no-padding-top">
                      <p>
                        <input type="radio" value="true" name="resp<?php echo $index; ?>" class="flat-red">
                        Verdadero
                      </p>
                      <p>
                        <input type="radio" value="false" name="resp<?php echo $index; ?>" class="flat-red">
                        Falso
                      </p>
                    </div>
                </blockquote>
...
<script type="text/javascript">
  $(function (){
    ...
    $("#from_test_vf").bind("submit",function(){
